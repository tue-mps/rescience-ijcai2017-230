...
"""
Running this file will output the mAP@k and recall@k per class and averaged for the PASCAL VOC 2007 testset. 
By running this script, all configurations as used in the paper are run back-to-back.
Be aware that this might take a while to fully run!
"""
...
# CONFIG
print("\n\nmodel: voc-FRCNN-resnet50, matrix type: none (baseline)\n")
...
# CONFIG
print("\n\nmodel: voc-FRCNN-resnet50, matrix type: KF-All\n")
model_type = 'voc-FRCNN-resnet50'   # choose between 'voc-FRCNN-resnet50', 'voc-FRCNN-resnet18' or 'voc-FRCNN-vgg16'
...
# CONFIG
print("\n\nmodel: voc-FRCNN-resnet50, matrix type: KF-500\n")
model_type = 'voc-FRCNN-resnet50'   # choose between 'voc-FRCNN-resnet50', 'voc-FRCNN-resnet18' or 'voc-FRCNN-vgg16'
matrix_type = 'KF-500-VOC'  # choose between 'KF-All-VOC', 'KF-500-VOC', 'KG-CNet-57-VOC' or 'KG-CNet-55-VOC'
detections_per_image = 500  # the maximum number of detected objects per image
num_iterations = 10         # number of iterations to calculate p_hat
box_score_threshold = 1e-5  # minimum score for a bounding box to be kept as detection (default = 0.05)
bk = 5                      # number of neighbouring bounding boxes to consider for p_hat
...
# CONFIG
print("\n\nmodel: voc-FRCNN-resnet50, matrix type: KG-CNet-57\n")
model_type = 'voc-FRCNN-resnet50'   # choose between 'voc-FRCNN-resnet50', 'voc-FRCNN-resnet18' or 'voc-FRCNN-vgg16'
...
# CONFIG
print("\n\nmodel: voc-FRCNN-resnet50, matrix type: KG-CNet-55\n")
model_type = 'voc-FRCNN-resnet50'   # choose between 'voc-FRCNN-resnet50', 'voc-FRCNN-resnet18' or 'voc-FRCNN-vgg16'
matrix_type = 'KG-CNet-55-VOC'  # choose between 'KF-All-VOC', 'KF-500-VOC', 'KG-CNet-57-VOC' or 'KG-CNet-55-VOC'
detections_per_image = 500  # the maximum number of detected objects per image
num_iterations = 10         # number of iterations to calculate p_hat
...
# CONFIG
print("\n\nmodel: voc-FRCNN-resnet18, matrix type: none (baseline)\n")
model_type = 'voc-FRCNN-resnet18'   # choose between 'voc-FRCNN-resnet50', 'voc-FRCNN-resnet18' or 'voc-FRCNN-vgg16'
matrix_type = 'KG-CNet-55-VOC'  # choose between 'KF-All-VOC', 'KF-500-VOC', 'KG-CNet-57-VOC' or 'KG-CNet-55-VOC'
detections_per_image = 500  # the maximum number of detected objects per image
num_iterations = 10         # number of iterations to calculate p_hat
box_score_threshold = 1e-5  # minimum score for a bounding box to be kept as detection (default = 0.05)
...
# CONFIG
print("\n\nmodel: voc-FRCNN-resnet18, matrix type: KF-All\n")
model_type = 'voc-FRCNN-resnet18'   # choose between 'voc-FRCNN-resnet50', 'voc-FRCNN-resnet18' or 'voc-FRCNN-vgg16'
matrix_type = 'KF-All-VOC'  # choose between 'KF-All-VOC', 'KF-500-VOC', 'KG-CNet-57-VOC' or 'KG-CNet-55-VOC'
detections_per_image = 500  # the maximum number of detected objects per image
num_iterations = 10         # number of iterations to calculate p_hat
...
# CONFIG
print("\n\nmodel: voc-FRCNN-resnet18, matrix type: KF-500\n")
model_type = 'voc-FRCNN-resnet18'   # choose between 'voc-FRCNN-resnet50', 'voc-FRCNN-resnet18' or 'voc-FRCNN-vgg16'
matrix_type = 'KF-500-VOC'  # choose between 'KF-All-VOC', 'KF-500-VOC', 'KG-CNet-57-VOC' or 'KG-CNet-55-VOC'
detections_per_image = 500  # the maximum number of detected objects per image
num_iterations = 10         # number of iterations to calculate p_hat
...
# CONFIG
print("\n\nmodel: voc-FRCNN-resnet18, matrix type: KG-CNet-57\n")
model_type = 'voc-FRCNN-resnet18'   # choose between 'voc-FRCNN-resnet50', 'voc-FRCNN-resnet18' or 'voc-FRCNN-vgg16'
matrix_type = 'KG-CNet-57-VOC'  # choose between 'KF-All-VOC', 'KF-500-VOC', 'KG-CNet-57-VOC' or 'KG-CNet-55-VOC'
detections_per_image = 500  # the maximum number of detected objects per image
num_iterations = 10         # number of iterations to calculate p_hat
...
# CONFIG
print("\n\nmodel: voc-FRCNN-resnet18, matrix type: KG-CNet-55\n")
model_type = 'voc-FRCNN-resnet18'   # choose between 'voc-FRCNN-resnet50', 'voc-FRCNN-resnet18' or 'voc-FRCNN-vgg16'
matrix_type = 'KG-CNet-55-VOC'  # choose between 'KF-All-VOC', 'KF-500-VOC', 'KG-CNet-57-VOC' or 'KG-CNet-55-VOC'
detections_per_image = 500  # the maximum number of detected objects per image
num_iterations = 10         # number of iterations to calculate p_hat
...
# CONFIG
print("\n\nmodel: voc-FRCNN-vgg16, matrix type: none (baseline)\n")
model_type = 'voc-FRCNN-vgg16'   # choose between 'voc-FRCNN-resnet50', 'voc-FRCNN-resnet18' or 'voc-FRCNN-vgg16'
matrix_type = 'KG-CNet-55-VOC'  # choose between 'KF-All-VOC', 'KF-500-VOC', 'KG-CNet-57-VOC' or 'KG-CNet-55-VOC'
detections_per_image = 500  # the maximum number of detected objects per image
num_iterations = 10         # number of iterations to calculate p_hat
box_score_threshold = 1e-5  # minimum score for a bounding box to be kept as detection (default = 0.05)
...
# CONFIG
print("\n\nmodel: voc-FRCNN-vgg16, matrix type: KF-All\n")
model_type = 'voc-FRCNN-vgg16'   # choose between 'voc-FRCNN-resnet50', 'voc-FRCNN-resnet18' or 'voc-FRCNN-vgg16'
matrix_type = 'KF-All-VOC'  # choose between 'KF-All-VOC', 'KF-500-VOC', 'KG-CNet-57-VOC' or 'KG-CNet-55-VOC'
detections_per_image = 500  # the maximum number of detected objects per image
num_iterations = 10         # number of iterations to calculate p_hat
...
# CONFIG
print("\n\nmodel: voc-FRCNN-vgg16, matrix type: KF-500\n")
model_type = 'voc-FRCNN-vgg16'   # choose between 'voc-FRCNN-resnet50', 'voc-FRCNN-resnet18' or 'voc-FRCNN-vgg16'
matrix_type = 'KF-500-VOC'  # choose between 'KF-All-VOC', 'KF-500-VOC', 'KG-CNet-57-VOC' or 'KG-CNet-55-VOC'
detections_per_image = 500  # the maximum number of detected objects per image
num_iterations = 10         # number of iterations to calculate p_hat
...
# CONFIG
print("\n\nmodel: voc-FRCNN-vgg16, matrix type: KG-CNet-57\n")
model_type = 'voc-FRCNN-vgg16'   # choose between 'voc-FRCNN-resnet50', 'voc-FRCNN-resnet18' or 'voc-FRCNN-vgg16'
matrix_type = 'KG-CNet-57-VOC'  # choose between 'KF-All-VOC', 'KF-500-VOC', 'KG-CNet-57-VOC' or 'KG-CNet-55-VOC'
detections_per_image = 500  # the maximum number of detected objects per image
num_iterations = 10         # number of iterations to calculate p_hat
...
# CONFIG
print("\n\nmodel: voc-FRCNN-vgg16, matrix type: KG-CNet-55\n")
model_type = 'voc-FRCNN-vgg16'   # choose between 'voc-FRCNN-resnet50', 'voc-FRCNN-resnet18' or 'voc-FRCNN-vgg16'
matrix_type = 'KG-CNet-55-VOC'  # choose between 'KF-All-VOC', 'KF-500-VOC', 'KG-CNet-57-VOC' or 'KG-CNet-55-VOC'
detections_per_image = 500  # the maximum number of detected objects per image
num_iterations = 10         # number of iterations to calculate p_hat
